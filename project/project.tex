...
\begin{abstract}
This paper explain the development of an app from the initial design phase, through several prototypes. Throughout the paper will there be referred to multiple figures, which will help to understand the design. Using known prototyping- and evaluation tools, the app is beeing evaluated on different design stages. In the end there is a discussion of the result and some remarks on future development. 
