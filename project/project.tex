...
\begin{abstract}
This paper explain the development of an app from the initial design phase, through several prototypes. The prototypes are explained and documented through text and figures which explains the process. Using several prototyping- and evaluation-tools, the app is evaluated in different design stages. In the end there is a discussion of the result a conclusion and some remarks on possible future development. 
