...
\begin{abstract}
This paper explain the development of an app meant as a solution to the problem: You don’t know when a friend is nearby but you would like to know in certain situations. The initial design phase and through several prototypes are explained. The prototypes are explained and documented through text and figures which explains the process. Using several prototyping- and evaluation-tools, the app is evaluated in different design stages. In the end there is a discussion of the result a conclusion and some remarks on possible future development. 
