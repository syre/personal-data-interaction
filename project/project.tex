...
\label{fig:hi-fi friendlist expanded}
\end{figure}
...
\label{fig:hi-fi friendlist collapsed}
\end{figure}
...
\label{fig:hi-fi notification app}
\end{figure}
...
\label{fig:hi-fi notification watch}
\end{figure}
...
\begin{landscape}
\newgeometry{left=5cm, right=5cm} %, right=0cm, bottom=0cm, top=0cm
\begin{figure}
\centering
\caption{User story map}
\includegraphics[trim= 0cm 10cm 0cm 0cm, clip=true]{figures/user_story_mapping}
